...
/* @@@@ USERCODE FILE Ethernet Interface configuration */
/**
  ******************************************************************************
...
/* Stack size of the interface thread (bytes).
   Must be large enough for ethernetif_input → HAL_ETH_ReadData → tcpip_input */
...
err_t ethernetif_init(struct netif *netif)
{
  ...
  netif->hostname = "Stm32FreeRtosEthDemo";
...
void HAL_ETH_MspInit(ETH_HandleTypeDef* ethHandle)
{
  ...
  /* USER CODE BEGIN ETH_MspInit 1 */
    /* ETH interrupt: priority must be >= configLIBRARY_MAX_SYSCALL_INTERRUPT_PRIORITY (5)
       because the ISR calls FreeRTOS API (osSemaphoreRelease) */
