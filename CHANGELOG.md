...
- New demos `ptp_demo` and `ptp4l_demo` demonstrating XCP PTP support and a PTP observer and PTP time server with XCP instrumentation (see README.md of `ptp_demo` for details)
