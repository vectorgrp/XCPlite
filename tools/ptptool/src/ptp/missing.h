...
/* With _GNU_SOURCE, modern glibc provides clock_adjtime */
#ifdef _GNU_SOURCE
...
static inline int clock_adjtime(clockid_t id, struct timex *tx) { return syscall(__NR_clock_adjtime, id, tx); }
#endif
...
static inline int timerfd_create(int clockid, int flags) { return syscall(__NR_timerfd_create, clockid, flags); }
