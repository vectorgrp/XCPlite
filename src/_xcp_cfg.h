...
#ifndef XCP_CFG_H // Include guard needed for manual control
#define XCP_CFG_H
...
#define XCP_DAQ_MEM_SIZE (5*100000) // Amount of memory for DAQ tables, each ODT entry (e.g. measurement variable) needs 5 bytes
