...
#define CRO_SET_MTA_EXT CRO_BYTE(3) // address extension as BYTE
...
#define CRO_SHORT_UPLOAD_EXT CRO_BYTE(3) // address extension as BYTE
...
#define CRO_SHORT_DOWNLOAD_EXT CRO_BYTE(3) // address extension as BYTE
...
#define CRM_GET_SEGMENT_INFO_ADDRESS_EXTENSION CRM_BYTE(2) // address extension as BYTE
...
#define CRO_WRITE_DAQ_EXT CRO_BYTE(3) // address extension as BYTE
...
#define CRO_WRITE_DAQ_MULTIPLE_EXT(i) CRO_BYTE(8 + (8 * (i))) // address extension as BYTE
...
#define CRM_READ_DAQ_EXT CRM_BYTE(3) // address extension as BYTE
