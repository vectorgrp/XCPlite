...
#define CRM_GET_SEGMENT_INFO_LEN_MODE0 8 // response length for mode 0
#define CRM_GET_SEGMENT_INFO_BASIC_INFO CRM_DWORD(1)
#define CRM_GET_SEGMENT_INFO_LEN_MODE1 6 // response length for mode 1
...
#define CRM_GET_SEGMENT_INFO_LEN_MODE2 8 // response length for mode 2
